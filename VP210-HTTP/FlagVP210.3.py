...
"""
In PowerShell, this entire script can be done in 3 lines:
    $Uri = 'http://target1.bowneconsulting.com/protected/A2.3/index.php'
    $Cred = Get-Credential -UserName 'admin' # For automation/persistence use Get-SBCredential of the AZSBTools PS module
    Invoke-WebRequest -Uri $Uri -Credential $Cred -UserAgent 'python' | FL StatusCode,Content

StatusCode        : 200
Content           :  The flag is basic
"""